...
2. К регистрации допускается любой зарегистрированный пользователь linux.org.ru, кроме тех, кто указан в [«черном списке»](https://github.com/fat0troll/lorchess/blob/master/black_list.md)
3. Участники распределяются в изначальной таблице случайным образом в день начала турнира.
4. Турнир проводится по круговой системе в два круга (количеств туров будет определено после регистрации):
