...
case "$1" in
  ...
  "library-full" ) pgn4webPackageFileList="$pgn4webBaseFiles chess-informant-NAG-symbols-alternative.js chess-informant-NAG-symbols.js fide-lookup.js fonts/* images/* libs/README.txt libs/index.html libs/garbochess/* engine.* live/index.html live/*.pgn pgn4web-server-config.js";;
